...
* 
* ******************* Test in 4.2b.6 ****************************
* Add size parameter to the Stack Template
*
*/
...
int main()
{
	...
	// Intiliaze using default constructor
	Stack<int, 5> stk1;
	...
	*/
	Stack<int, 5> stk3 = stk1;

	/*Test the Copy constructor
	*/
	Stack<int, 5> stk2(stk1);
	...
	*/
	...
	/*Intialise stk4 to test for StackFullException
	*/
	Stack<int, 3> stk4;
