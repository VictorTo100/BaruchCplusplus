...
int main()
{
	...
	*/
	...
	MatrixPricer<EuropeanEquityOptions> pricerM2(callOption, option_matrix_parameters, 1.0, 60.0, 65.0, "Spot");
	std::vector<double> results_1(6);
	results_1 = pricerM2.CalculateMatrixPriceMesh(callOption, option_matrix_parameters_mesh, 1, 60.0, 65.0, "Spot");

	cout << "Price of the first option is: " << results_1[6] << endl;
