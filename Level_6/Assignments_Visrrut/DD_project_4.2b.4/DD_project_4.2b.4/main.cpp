...
int main()
{
	...
	*/
	for (int i = 0; i < 5; i++)
	{
		try
		{
			cout << "The values in Stack are: " << stk1.Pop() << "\n" << endl;
		}
		catch (ArrayException& err)
		{
			cout << err.GetMessage() << endl;
	...
	for (int i = 0; i < 5; i++)
	{
		try
		{
			cout << "The values in Stack are: " << stk2.Pop() << "\n" << endl;
		}
		catch (ArrayException& err)
		{
			cout << err.GetMessage() << endl;
	...
	for (int i = 0; i < 5; i++)
	{
		try
		{
			cout << "The values in Stack are: " << stk3.Pop() << "\n" << endl;
		}
		catch (ArrayException& err)
		{
			cout << err.GetMessage() << endl;
	...
	*/
	...
	/* Test Intialisation using paramter constructor with size argument
	* Also test out of bounds for the push function
	*/
